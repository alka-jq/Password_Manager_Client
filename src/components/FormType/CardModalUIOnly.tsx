...
// interface CardModalUIOnlyProps {
//   isOpen: boolean
//   mode: "add" | "edit"
//   card?: Card
//   vaults?: Vault[]
...
// const CardModalUIOnly: React.FC<CardModalUIOnlyProps> = ({
//   isOpen,
//   mode,
//   card,
//   vaults = [],
...
//                 className="w-full h-9 px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 dark:text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//               >
