            ...
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl animate-in zoom-in-95 duration-300">
                <div className="sticky top-0 z-10 flex items-center justify-between p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">{isEdit ? 'Edit Identity' : 'Create Identity'}</h2>
                            <p className="text-sm text-gray-600 dark:text-gray-400">{isEdit ? 'Update identity information' : 'Store personal and professional details'}</p>
                        </div>
                    </div>
                    {/* ==================================Cell DropDown===================================== */}
                    <div className="flex ">
                    ...
                    <form onSubmit={handleSubmit} className="p-5 space-y-5">
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                            ...
                            >
                                ...
                                {expandedSections.address ? <ChevronUp className="h-5 w-5 text-gray-500" /> : <ChevronDown className="h-5 w-5 text-gray-500" />}
                            </button>
                            ...
                            {expandedSections.address && (
                                <div className="p-4 pt-2 space-y-4 bg-white dark:bg-gray-800">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Street address, P.O. box</label>
                                            <input
                                                type="text"
                                                value={streetAddress}
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                            ...
                            >
                                ...
                                {expandedSections.work ? <ChevronUp className="h-5 w-5 text-gray-500" /> : <ChevronDown className="h-5 w-5 text-gray-500" />}
                            </button>
